...
describe("Creación de tags internos en la plataforma", function () {
    it("Creación de un nuevo internal tag con nombre inválido correo e2e - datos aleatorios usando 'Faker'", function () {
        ...
        // And El usuario introduce un nombre inválido en formato correo en el campo 'Nombre'
        const tagName = faker.internet.email(); // Usar correo como nombre inválido
...
describe("Creación de tags internos en la plataforma", function () {
    it("Creación de un nuevo internal tag con nombre inválido correo e2e - datos Apriori usando 'Mockaroo'", async function () {
        // Given Un usuario con credenciales válidas
        cy.visit(`${APP_PAGE}/ghost/#/signin`);
        const signinPage = new SigninPage(cy);
        const tagPage = new TagPage(cy);
        const { email , description } = await getPseudoRamdonMemeber();
        ...
        // And El usuario introduce un nombre inválido en formato correo en el campo 'Nombre'
        tagPage.getTagNameInput().type(email);
