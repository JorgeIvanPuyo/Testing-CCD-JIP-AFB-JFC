...
describe("Gestión de miembros en la plataforma", function () {
  it("Creación de un nuevo member con nombre inválido URL e2e - datos aleatorios usando 'Faker'", function () {
    ...
    cy.window().then((win) => {
      ...
      // Completar texto nombre con un formato URL
      const memberName = faker.internet.url(); // Usar URL como nombre inválido
...
describe("Gestión de miembros en la plataforma", function () {
  it("Creación de un nuevo member con nombre inválido URL e2e - datos aPriori usando 'Mockaroo'", function () {
    cy.visit(`${APP_PAGE}/ghost/#/signin`);
    cy.wait(1000);
